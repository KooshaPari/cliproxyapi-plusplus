...
type Config struct {
	...
	// ResponsesCompactEnabled gates the /responses/compact endpoint.
	// Nil means enabled (default behavior).
...
// IsResponsesCompactEnabled returns true when the /responses/compact endpoint
// should be available. Default is enabled when unset.
