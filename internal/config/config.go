...
type Config struct {
	...
	// ResponsesCompactEnabled controls whether responses are compacted before delivery.
	// Nil or true means enabled (default behavior), false means disabled.
...
// IsResponsesCompactEnabled returns true when responses should be compacted before delivery.
