...
type Config struct {
	...
	// ResponsesCompactEnabled gates the responses compact feature for the OpenAI compatibility path.
	// Nil means enabled (default behavior).
...
// IsResponsesCompactEnabled returns true when the responses compact feature
// should be enabled. Default is enabled when unset.
